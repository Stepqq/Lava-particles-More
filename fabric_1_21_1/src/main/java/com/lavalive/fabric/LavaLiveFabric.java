...
public class LavaLiveFabric implements ModInitializer {
    ...
    public void onInitialize() {
        ResourceLocation popLoc = ResourceLocation.fromNamespaceAndPath(MODID, "lava_bubble_pop");
        ResourceLocation rumbleLoc = ResourceLocation.fromNamespaceAndPath(MODID, "lava_rumble");
        ...
        Registry.register(BuiltInRegistries.PARTICLE_TYPE, ResourceLocation.fromNamespaceAndPath(MODID, "lava_bubble"), LAVA_BUBBLE);
        Registry.register(BuiltInRegistries.PARTICLE_TYPE, ResourceLocation.fromNamespaceAndPath(MODID, "lava_bubble_small"), LAVA_BUBBLE_SMALL);
        Registry.register(BuiltInRegistries.PARTICLE_TYPE, ResourceLocation.fromNamespaceAndPath(MODID, "magma_fragment"), MAGMA_FRAGMENT);
        Registry.register(BuiltInRegistries.PARTICLE_TYPE, ResourceLocation.fromNamespaceAndPath(MODID, "ember_spark"), EMBER_SPARK);
        Registry.register(BuiltInRegistries.PARTICLE_TYPE, ResourceLocation.fromNamespaceAndPath(MODID, "volcanic_ash"), VOLCANIC_ASH);
        Registry.register(BuiltInRegistries.PARTICLE_TYPE, ResourceLocation.fromNamespaceAndPath(MODID, "heat_shimmer"), HEAT_SHIMMER);
